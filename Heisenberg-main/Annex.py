...
class TextSpeech:
    ...
    def opentxt(self):
        ...
        try:
            file_path=filedialog.askopenfilename(initialdir =r"C:\Users\Asus\Desktop\Heisenberg-main\Heisenberg-main\Notes",title="Select file",filetypes=(('text file',"*.txt"),("All files", "*.*")))
